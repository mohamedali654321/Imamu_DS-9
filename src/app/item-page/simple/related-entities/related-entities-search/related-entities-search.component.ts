    ...
    if (this.relationLabel.includes("Of") === true) {
      this.filterFields =
        ...
        this.relationLabel.split("is")[1].split("Of")[0] !== "Perent"
          ?(this.relationLabel.split("is")[1].split("Of")[0].includes("Child") || this.relationLabel.split("is")[1].split("Of")[0].includes("Parent"))? this.item.firstMetadataValue("dspace.entity.type"): this.relationLabel.split("is")[1].split("Of")[0]
